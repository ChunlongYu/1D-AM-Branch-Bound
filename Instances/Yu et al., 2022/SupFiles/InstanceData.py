    ...
    for i in range(types_mac):
        ...
        if num_mac_type > 1:
            for j in range(num_mac_type):
                ...
                [V[count_mac-1], U[count_mac-1],S[count_mac-1],L[count_mac-1],W[count_mac-1],H[count_mac-1] ]
...
# def modInstance(path):
#     # This function modify the size of parts in a instance, and save as a new instance
#     ## ==== Read data =====
...
#     return types_mac,types_parts,num_mac,num_parts, V,U,S,L,W,HM,v,Kj,h,l,w,s
###  ==== Test ====
#path = "/TestInstances/ht1_1.txt"   
#path = "/TestInstances/inst_test.txt"   
#[types_mac,types_parts,num_mac,num_parts, V,U,S,L,W,HM,v,Kj,h,l,w,s] = readInstance(path)
